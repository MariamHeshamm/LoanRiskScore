...
#MSE
MSE=Pickled_LR_Model.mean_squared_error
...
pred=m_jlib.predict(X_test)
print(pred)
print(m_jlib.score(X_test,y_test))
print('MSE', metrics.mean_squared_error(np.asarray(y_test), pred))
